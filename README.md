...
* [Static Site Generators](https://staticsitegenerators.net/) List of probably all available static site generators that can be used for generating documentation pages. You can see which ones are the most popular and what technology was used to build it. It makes it easier to do a initial selection before deeper investigation into what tool to choose (contributed by [Lukasz Gornicki](https://github.com/derberg))
* [RAML2HTML](https://github.com/raml2html/raml2html) It generates HTML documentation. One of many tools you can use if you document your REST API reference using [RAML](http://raml.org/) specification. More of such tools listed in [RAML Projects List](http://raml.org/projects/projects)(contributed by [Lukasz Gornicki](https://github.com/derberg))
