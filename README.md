...
* [Rust Guides](http://doc.rust-lang.org/book/README.html) - Rust is a systems programming language. Excellent documentation is a high priority of its creators. Auto-generation of docs from special comment blocks is a first-class language feature. Also supports automated testing of inline code examples. (contributed by [Nick Cox](https://github.com/thenickcox) and updated by [Steven Syrek](https://github.com/sjsyrek))
