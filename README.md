...
* [Vale.sh](https://vale.sh/) A command-line linter for prose. Automate editorial checks in accordance with the bundled style guides, or add custom rules to reflect your own house styles. (Contributed by [Lex Joy](https://github.com/lex-joy))
