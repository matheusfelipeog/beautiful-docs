...
* [Dropwizard](https://dropwizard.github.io/dropwizard/) - Beautiful and concise; another Bootstrap joint. (contributed by [mrtazz](https://twitter.com/#!/mrtazz)).)
...
* [Twitter Developers Docs](https://dev.twitter.com/overview/documentation) - In-depth and very well organized. (contributed by [@tsantero](https://twitter.com/#!/tsantero))
...
* [Rust Guides](http://doc.rust-lang.org/book/README.html) - Rust is a production-ready, systems programming language intended as a successor to C++. Excellent documentation (written by [Steve Klabnik](https://github.com/steveklabnik)) is a high priority of this language. The guides, in particular, illustrate core concepts of the standard library in a conversational, accessible style. In addition, the importance that Rust's maintainers give to documentation is reflected directly in its syntax: the commenting system, in addition to supporting the auto-generation of docs from special comment blocks as a first-class language feature, also provides for automated testing of inline code examples. A standard tool for performing these tasks, [rustdoc](https://doc.rust-lang.org/book/documentation.html), is included with distributions of Rust. (contributed by [Nick Cox](https://github.com/thenickcox) and updated by [Steven Syrek](https://github.com/sjsyrek))
...
* [Markdoc](http://markdocs.org/) - Lightweight documentation/wiki generator in Python, released in the [public domain](http://unlicense.org/). (contributed by [Neelfyn](http://neelfyn.info/))
