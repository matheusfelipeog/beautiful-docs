...
* [FullCalendar](http://arshaw.com/fullcalendar/docs/) – Concise overview of all APIs on a single page, and in depth detail descriptions for each. (contributed by [gr2m](https://github.com/gr2m/))
