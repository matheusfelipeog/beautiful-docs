...
* [Rust Guides](http://doc.rust-lang.org/book/README.html) - Rust is a production-ready, systems programming language. Excellent documentation (written by [Steve Klabnik](https://github.com/steveklabnik)) is a high priority of this language. The commenting system supports the auto-generation of docs from special comment blocks as a first-class language feature and provides for automated testing of inline code examples. (contributed by [Nick Cox](https://github.com/thenickcox) and updated by [Steven Syrek](https://github.com/sjsyrek))
