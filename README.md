...
* [FastAPI](https://fastapi.tiangolo.com) - Python framework for building APIs that automatically generate [Redoc](https://github.com/Redocly/redoc) or [Swagger UI]
(https://swagger.io) documentation for the REST routes (contributed by [@jrwaine](https://github.com/jrwaine))
